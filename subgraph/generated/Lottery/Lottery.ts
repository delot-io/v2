...
export class DividerTransferred extends ethereum.Event {
  get params(): DividerTransferred__Params {
    return new DividerTransferred__Params(this);
  }
}

export class DividerTransferred__Params {
  _event: DividerTransferred;

  constructor(event: DividerTransferred) {
    this._event = event;
  }
...
export class Lottery___roundsResult {
  ...
  getDepositMultiplier(): BigInt {
    return this.value4;
  }

  getHoldMultiplier(): BigInt {
    return this.value5;
  }
  ...
  getWinnerPayoutRatio(): BigInt {
    return this.value8;
  }

  getNftHoldersPayoutRatio(): BigInt {
    return this.value9;
  }

  getNumPlayers(): BigInt {
    return this.value10;
  }
}
...
export class Lottery__getRoundPlayerInfoResult {
  ...
  getDepositTickets(): BigInt {
    return this.value1;
  }

  getHoldAmount(): BigInt {
    return this.value2;
  }

  getHoldTickets(): BigInt {
    return this.value3;
  }
...
export class Lottery extends ethereum.SmartContract {
  ...
  try__dividerAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "_dividerAddress",
      "_dividerAddress():(address)",
      []
  ...
  _roundNftHoldersPayoutRatio(): BigInt {
    let result = super.call(
      "_roundNftHoldersPayoutRatio",
      "_roundNftHoldersPayoutRatio():(uint256)",
      []
    );
  ...
  try__roundNftHoldersPayoutRatio(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_roundNftHoldersPayoutRatio",
      "_roundNftHoldersPayoutRatio():(uint256)",
      []
